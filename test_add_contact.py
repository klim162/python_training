...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.filling_fields(wd, firstname="ewfweqf", middlename="erferfg", lastname="wfqwvdv",
    ...
    def filling_fields(self, wd, firstname, middlename, lastname, nickname, title, company, address,
                       phonehome, phonemobile, phonework, phonefax, email, email2, email3, homepage,
        ...
        wd.find_element_by_name("mobile").send_keys(phonemobile)
        # add work phone number
        wd.find_element_by_name("work").click()
        wd.find_element_by_name("work").clear()
        wd.find_element_by_name("work").send_keys(phonework)
        # add fax phone number
        wd.find_element_by_name("fax").click()
        wd.find_element_by_name("fax").clear()
        wd.find_element_by_name("fax").send_keys(phonefax)
        # add email1
        ...
        wd.find_element_by_xpath("//option[@value='28']").click()
        ...
        wd.find_element_by_xpath("//div[@id='content']/form/select[3]/option[30]").click()
